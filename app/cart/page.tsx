                ...
                {items.length === 0 ? (
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            {items.map((item) => (
                                <Card key={item.variantId} className="p-4 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                                    ...
                                    <div className="flex-1 space-y-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {item.size && (
                                                <span className="text-[10px] font-bold uppercase py-0.5 px-2 bg-muted text-muted-foreground rounded-full border border-border">
                                                    {item.size}
                                                </span>
                                            )}
                                        </div>
