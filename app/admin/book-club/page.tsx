    ...
    <div className="p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
        <div>
          ...
          <p className="text-lg text-muted-foreground">Curate the featured reading experience for the community</p>
        </div>
        <Button size="lg" className="font-display tracking-wider text-lg" onClick={() => setIsModalOpen(true)}>
        ...
        {currentSelection && currentBook ? (
          <Card className="overflow-hidden border-secondary/30 bg-secondary/5 backdrop-blur-md relative transform hover:scale-[1.01] transition-all duration-300">
            ...
            <div className="grid md:grid-cols-[250px_1fr] gap-8 p-8">
              <div className="relative aspect-[3/4] shadow-2xl rounded-lg overflow-hidden border border-white/10">
                <Image
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-1">
                  ...
                  <h3 className="font-display text-6xl tracking-wider text-white">
                    {currentBook.title}
                  </h3>
                  <p className="text-2xl text-muted-foreground">by {currentBook.author}</p>
                </div>

                <div className="space-y-2 max-w-2xl">
                  <p className="text-secondary font-display text-xl tracking-wide uppercase italic">
                ...
                <div className="flex gap-4 pt-4">
                  <Button variant="outline" className="border-border/50 hover:bg-white/5" onClick={() => setIsModalOpen(true)}>
      ...
      <section>
        ...
        <div className="grid gap-4">
          {selections.filter(s => s.status !== "current").map((selection) => {
            ...
            return (
              <Card key={selection.id} className="p-4 bg-background border-border/50 hover:border-primary/30 transition-colors group">
                <div className="flex items-center gap-6">
                  <div className="w-12 h-18 relative rounded overflow-hidden flex-shrink-0 shadow-lg">
                    <Image
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <h4 className="font-display text-xl tracking-wide truncate group-hover:text-primary transition-colors">
                      {book.title}
                    </h4>
                    <p className="text-xs text-muted-foreground truncate">{selection.theme}</p>
                  </div>
